...
import 'package:flutter_garage_true/components/mechanicprofile/components/profilebody.dart';
...
class machanicprofileScreen extends StatefulWidget {
  ...
  @override
  State<machanicprofileScreen> createState() => _machanicprofileScreenState();
}

class _machanicprofileScreenState extends State<machanicprofileScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: buildAppBar(),
      body: machanicprofilebody(
