...
class mechanicDetaillistPage extends StatefulWidget {
  ...
  @override
  mechanicDetaillistPageState createState() => mechanicDetaillistPageState();
}

class mechanicDetaillistPageState extends State<mechanicDetaillistPage> {
  bool _like = false;
