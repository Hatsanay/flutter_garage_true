...
class mechanicdtllistScreen extends StatefulWidget {
  ...
  @override
  State<mechanicdtllistScreen> createState() => _dtllistScreenState();
}

class _dtllistScreenState extends State<mechanicdtllistScreen> {
  @override
