...
import 'package:flutter_garage_true/components/machanicrepair_teaking.dart%20copy/repair_traking_page.dart';
...
class mechanicrepairtrakingScreen extends StatefulWidget {
  ...
  @override
  State<mechanicrepairtrakingScreen> createState() =>
      _mechanicrepairtrakingScreenState();
}

class _mechanicrepairtrakingScreenState
    extends State<mechanicrepairtrakingScreen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: buildAppBar(),
      body: mechanicOrderTrackingPage(
