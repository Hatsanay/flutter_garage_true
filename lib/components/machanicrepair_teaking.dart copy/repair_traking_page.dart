...
class mechanicOrderTrackingPage extends StatefulWidget {
  ...
  @override
  State<mechanicOrderTrackingPage> createState() =>
      mechanicOrderTrackingPageState();
}

class mechanicOrderTrackingPageState extends State<mechanicOrderTrackingPage> {
